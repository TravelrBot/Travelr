...
let test = { geocoded_waypoints: 
   [ { geocoder_status: 'OK',
       place_id: 'EiY4MDAtMTA5OCBNYXJ5IEF2ZSwgV2FjbywgVFggNzY3MDEsIFVTQQ',
       types: [ 'street_address' ] },
     { geocoder_status: 'OK',
       place_id: 'ChIJfUjN-EGCT4YRN4kR0_CZLmc',
       types: [ 'street_address' ] } ],
  routes: 
   [ { bounds: 
        { northeast: { lat: 31.5551278, lng: -97.1139632 },
          southwest: { lat: 31.5488473, lng: -97.1329849 } },
       copyrights: 'Map data ©2017 Google',
       legs: 
        [ { distance: { text: '1.5 mi', value: 2407 },
            duration: { text: '30 mins', value: 1788 },
            end_address: '60 Baylor Ave, Waco, TX 76706, USA',
            end_location: { lat: 31.5498498, lng: -97.1143043 },
            start_address: '800-1098 Mary Ave, Waco, TX 76701, USA',
            start_location: { lat: 31.5525052, lng: -97.1329849 },
            steps: 
             [ { distance: { text: '1.5 mi', value: 2407 },
                 duration: { text: '30 mins', value: 1788 },
                 end_location: { lat: 31.5498498, lng: -97.1143043 },
                 html_instructions: 'Walk to 60 Baylor Ave, Waco, TX 76706, USA',
                 polyline: { points: 'erq_EbhzoQiAqAyCsDmCeDyCmDZe@fC}CHK|C{DnAeBrA_BhHcJz@eAv@aAPYJUFQBKT_AJgA@GNq@?ADQ@IJ}@@q@MeBGo@Ms@Kc@Sc@]e@]e@Y]wAeB`AoABE?C?AY_@CCRWFI@IBUBc@@EDIV]BCDCFCV[@CJGDGNY?AJMJGBAt@u@?G?A@G@M@K?K?E?{@AcAR[DGFIXWF]BU@s@?UAMCIMSEG|BqCFKJKBI?A?E?A?C?AEGACOOMOmA{AECCACAE?C@C@CBs@z@' },
                 start_location: { lat: 31.5525052, lng: -97.1329849 },
                 steps: 
                  [ { distance: { text: '0.3 mi', value: 408 },
                      duration: { text: '5 mins', value: 296 },
                      end_location: { lat: 31.5551278, lng: -97.12996919999999 },
                      html_instructions: 'Head <b>northeast</b> on <b>Mary Ave</b> toward <b>S 8th St</b>',
                      polyline: { points: 'erq_EbhzoQiAqAyCsDmCeDyCmD' },
                      start_location: { lat: 31.5525052, lng: -97.1329849 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '0.6 mi', value: 931 },
                      duration: { text: '12 mins', value: 703 },
                      end_location: { lat: 31.5500021, lng: -97.1224684 },
                      html_instructions: 'Turn <b>right</b> onto <b>S 5th St</b>',
                      maneuver: 'turn-right',
                      polyline: { points: 'qbr_EhuyoQZe@fC}CHK|C{DnAeBrA_BhHcJz@eAv@aAPYJUFQBKT_AJgA@GNq@?ADQ@IJ}@@q@' },
                      start_location: { lat: 31.5551278, lng: -97.12996919999999 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '0.2 mi', value: 275 },
                      duration: { text: '3 mins', value: 208 },
                      end_location: { lat: 31.5512098, lng: -97.1200568 },
                      html_instructions: 'Continue onto <b>FM434 S</b>',
                      polyline: { points: 'obq_ElfxoQMeBGo@Ms@Kc@Sc@]e@]e@Y]wAeB' },
                      start_location: { lat: 31.5500021, lng: -97.1224684 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '272 ft', value: 83 },
                      duration: { text: '1 min', value: 65 },
                      end_location: { lat: 31.5510086, lng: -97.1194182 },
                      html_instructions: 'Turn <b>right</b> toward <b>Baylor Ave</b>',
                      maneuver: 'turn-right',
                      polyline: { points: 'ajq_EjwwoQ`AoABE?C?AY_@CC' },
                      start_location: { lat: 31.5512098, lng: -97.1200568 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '0.1 mi', value: 204 },
                      duration: { text: '2 mins', value: 149 },
                      end_location: { lat: 31.5498559, lng: -97.11784879999999 },
                      html_instructions: 'Turn <b>right</b> toward <b>Baylor Ave</b>',
                      maneuver: 'turn-right',
                      polyline: { points: 'yhq_EjswoQRWFI@IBUBc@@EDIV]BCDCFCV[@CJGDGNY?AJMJGBAt@u@' },
                      start_location: { lat: 31.5510086, lng: -97.1194182 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '295 ft', value: 90 },
                      duration: { text: '1 min', value: 64 },
                      end_location: { lat: 31.5498354, lng: -97.1169042 },
                      html_instructions: 'Turn <b>left</b> onto <b>Baylor Ave</b>',
                      maneuver: 'turn-left',
                      polyline: { points: 'saq_EpiwoQ?G?A@G@M@K?K?E?{@AcA' },
                      start_location: { lat: 31.5498559, lng: -97.11784879999999 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '449 ft', value: 137 },
                      duration: { text: '2 mins', value: 99 },
                      end_location: { lat: 31.5495977, lng: -97.1156601 },
                      html_instructions: 'Slight <b>right</b> toward <b>S 1st St</b>',
                      maneuver: 'turn-slight-right',
                      polyline: { points: 'oaq_ErcwoQR[DGFIXWF]BU@s@?UAMCIMSEG' },
                      start_location: { lat: 31.5498354, lng: -97.1169042 },
                      travel_mode: 'WALKING' },
                    { distance: { text: '0.2 mi', value: 279 },
                      duration: { text: '3 mins', value: 204 },
                      end_location: { lat: 31.5498498, lng: -97.1143043 },
                      html_instructions: 'Turn <b>right</b> onto <b>S 1st St</b><div style="font-size:0.9em">Destination will be on the right</div>',
                      maneuver: 'turn-right',
                      polyline: { points: '_`q_Ez{voQ|BqCFKJKBI?A?E?A?C?AEGACOOMOmA{AECCACAE?C@C@CBs@z@' },
                      start_location: { lat: 31.5495977, lng: -97.1156601 },
                      travel_mode: 'WALKING' } ],
                 travel_mode: 'WALKING' } ],
            traffic_speed_entry: [],
            via_waypoint: [] } ],
       overview_polyline: { points: 'erq_EbhzoQcFeGgHsIZe@fC}CfDgEbDeEdJiLhA{ARg@XkALoAVoAJ}@@q@UuCMs@Kc@Sc@]e@w@cAwAeB`AoABIYa@CCRWHSFy@FOZa@LGj@o@N[VUx@w@?IDm@?aAAcAR[LQXWF]DiAAc@Q]EG|BqCRWBK?MGK]_@sA_BGCI@GDs@z@' },
       summary: 'S 5th St',
...
for (var route_step = 0; route_step < body.routes.length; route_step++) {
    ...
    legs.forEach(function (leg) {
        ...
        console.log(util.inspect(transitLegInfo, false, null));
    });
}
